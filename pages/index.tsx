  ...
  return (
    <>
      <PageTemplate title="Marmi Mainardi">
        {/* Banner Section */}
        <section
          className="flex flex-col gap-10 items-center my-16"
          data-aos="fade-up"
        >
          <div className="flex flex-col gap-6 w-full sm:w-fit text-center md:text-start items-center flex-col md:flex-row">
            ...
            <div className='mt-5'>
              <Image src={'https://marmi-mainardi.s3.amazonaws.com/images/jumbo.png'} width='1090px' height={1000} alt='company brand' loading='lazy' />
            </div>
          ...
          <div className="flex flex-col gap-6 sm:flex-row w-full sm:w-fit mt-6">
          ...
          <div className="text-center sm:w-10/12 md:w-8/12 lg:w-6/12" data-aos="zoom-in-up">
            <SectionSentence
              title="Sculture in Pietra:<br> Un Mondo di Possibilità"
              badge=""
            />
          </div>
